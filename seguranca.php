...
white-space: pre-wrap;       /* Since CSS 2.1 */
  ...
  <body class="home">
    ...
    <h1 class="mt-5 d-flex justify-content-center mb-0 ">Destaques Segurança</h1>
  ...
  $result = mysqli_query($db, "SELECT * FROM images WHERE categoria ='seguranca' ORDER BY id desc");
