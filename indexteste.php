...
white-space: pre-wrap;       /* Since CSS 2.1 */
  ...
  <body class="home">
        ...
        <div class="container">
          ...
          <div class="collapse navbar-collapse " id="nav-principal">
            <ul class="navbar-nav ml-auto ">
              ...
              <li class="nav-item">
                <a href="celulares.php" class="nav-link text-light">Celulares</a>
              </li>
              <li class="nav-item">
                <a href="informatica.php" class="nav-link text-light">Informática</a>
              </li>
              <li class="nav-item">
                <a href="seguranca.php" class="nav-link text-light">Segurança</a>
              </li>
    ...
    while ($crow2 = mysqli_fetch_array($carrosel2)) {
          ...
          echo "  <a href='./noticia.php?id=" .$crow2['id'] ."'> 
    ...
    while ($prow = mysqli_fetch_array($principal)) {
           ...
           echo " <img src='images/".$prow['image']."' class='border rounded' width='660px' height='330px'>
              <p><pre>
               ...
               echo "  <a href='./noticia.php?id=" .$prow['id'] ."' class='btn btn-dark'>  Leia mais</a> <br>";
	}?>
    ...
    while ($lrow = mysqli_fetch_array($laterals)) {
            ...
            echo " <p>
             ...
             echo " <ul class='navbar-nav ml-auto '>
                <li class='nav-item'>
                  <a href='./noticia.php?id=" .$lrow['id'] ."' class='nav-link text-secundary'>Leia mais</a>
                </li>
              </ul>
...
?>
            ...
            <div class="input-group">
              <input type="email" placeholder="Seu e-mail" class="form-control" name="email">
              <div class="input-group-append">
                <button type="submit" class="btn btn-dark btn-sm" name="upload">Cadastre-se</button></form>
              </div>
            </div>
           </div>
