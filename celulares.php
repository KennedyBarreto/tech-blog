...
white-space: pre-wrap;       /* Since CSS 2.1 */
  ...
  <body class="home">
        ...
        <div class="container">
          ...
          <div class="collapse navbar-collapse " id="nav-principal">
            <ul class="navbar-nav ml-auto ">
              ...
              <li class="nav-item">
                <a href="" class="nav-link text-light">Celulares</a>
              </li>
              <li class="nav-item">
    ...
    <h1 class="mt-5 d-flex justify-content-center mb-0 ">Destaques Celulares</h1>
  ...
  $result = mysqli_query($db, "SELECT * FROM images WHERE categoria ='celulares' ORDER BY id desc");
